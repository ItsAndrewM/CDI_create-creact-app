...
const getProductCategoriesByPage = async (pageNum) => {
  return WooCommerce.get(`products/categories?page=${pageNum}&per_page=20`)
    .then((response) => {
...
module.exports = { getProductCategoriesByPage };
